...
t1 = Treehouse.new(user: User.first, name: names[0], description: descriptions[0], price_per_day: prices[0], cancel_days: cancel_days[0], address: "Berlin")
...
t1.save
t2 = Treehouse.new(user: User.first, name: names[1], description: descriptions[1], price_per_day: prices[1], cancel_days: cancel_days[1], address: "Paris")
...
t2.save
t3 = Treehouse.new(user: User.first, name: names[2], description: descriptions[2], price_per_day: prices[2], cancel_days: cancel_days[2], address: "Rome")
...
t3.save
t4 = Treehouse.new(user: User.first, name: names[3], description: descriptions[3], price_per_day: prices[3], cancel_days: cancel_days[3], address: "Amsterdam")
